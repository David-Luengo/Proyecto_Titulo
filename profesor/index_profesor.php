...
$query = "SELECT nombre, apellido, correo, numero, direccion, correo_personal FROM profesor WHERE correo = $1";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['guardar'])) {
  ...
  $query_update = "UPDATE profesor SET nombre = $1, apellido = $2, correo = $3, numero = $4, direccion = $5, correo_personal = $6 WHERE correo = $7";
